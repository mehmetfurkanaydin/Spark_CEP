...
public class CalculateCosineSimilarity
{
    ...
    public  double Cosine_Similarity_Score(String Text1, String Text2)
    {
        ...
        Hashtable<String, values> word_freq_vector = new Hashtable<String, CalculateCosineSimilarity.values>();
    ...
    {
        CalculateCosineSimilarity cs1 = new CalculateCosineSimilarity();

        double sim_score = cs1.Cosine_Similarity_Score(text1,text2);
        //System.out.println(text1+"--"+text2+"--"+Double.toString(sim_score));
        return sim_score;
    }
}